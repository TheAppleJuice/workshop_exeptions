	    ...
	    public void addFemaleFirstName(String name){
			try {
				if (femaleFirstNames.contains(name))
					throw new DuplicateNameException("Entered female first name already exists");
				else
	    ...
	    public void addMaleFirstName(String name) throws DuplicateNameException {
			try {
				if (maleFirstNames.contains(name))
					throw new DuplicateNameException("Entered male first name already exists");
				else
	    ...
	    public void addLastName(String lastName){
			try {
				if (lastNames.contains(lastName)){
					throw new DuplicateNameException("Entered last name already exists");
				} else
